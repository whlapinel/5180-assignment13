...
import edu.uncc.assignment13.databinding.FragmentSelectPriorityBinding;
...
public class SelectPriorityFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        binding.listView.setAdapter(new ArrayAdapter<String>(getContext(), android.R.layout.simple_list_item_1, Data.priorities));
    }
